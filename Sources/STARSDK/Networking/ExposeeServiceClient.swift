...
class ExposeeServiceClient {
    ...
    public init(descriptor: TracingApplicationDescriptor) {
        ...
        exposeeEndpoint = ExposeeEndpoint(baseURL: descriptor.listBaseUrl)
    ...
    func getExposee(dayIdentifier: String, completion: @escaping (Result<[KnownCaseModel], STARTracingErrors>) -> Void) {
    ...
    ///   - completion: The completion block
    func addExposee(_ exposee: ExposeeModel, completion: @escaping (Result<Void, STARTracingErrors>) -> Void) {
    ...
    ///   - completion: The completion block
    func removeExposee(_ exposee: ExposeeModel, completion: @escaping (Result<Void, STARTracingErrors>) -> Void) {
    ...
    ///   - completion: The completion block
    private func exposeeEndpointRequest(_ exposee: ExposeeModel, action: ExposeeEndpointAction, completion: @escaping (Result<Void, STARTracingErrors>) -> Void) {
        // addExposee endpoint
        let url: URL
        switch action {
        case .add:
    ...
    ///   - completion: The completion block
    static func getAvailableApplicationDescriptors(enviroment: Enviroment, completion: @escaping (Result<[TracingApplicationDescriptor], STARTracingErrors>) -> Void) {
